...
for train_index,test_index in skf.split(atribute, output):
    ...
    YBF5_1 =  YBF3_1.reshape([YBF3_1.shape[0]*YBF3_1.shape[1]])
...
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF3_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF3_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF3_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF5_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF5_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF5_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF7_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF7_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF7_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF9_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF9_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(AUCBF9_3)) + "\n")
...
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF3_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF3_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF3_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF5_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF5_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF5_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF7_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF7_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF7_3)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF9_1)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF9_2)) + "\n")
file.write('CROSS ACC GCRFCB3_fast prediktora je {}'.format(np.mean(ACCBF9_3)) + "\n")
...
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF3_1)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF3_2)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF3_3)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF5_1)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF5_2)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF5_3)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF7_1)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF7_2)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF7_3)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF9_1)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF9_2)) + "\n")
file.write("--- %s seconds mean --- GCRFCB3_fast" % (np.sum(timeBF9_3)) + "\n")
